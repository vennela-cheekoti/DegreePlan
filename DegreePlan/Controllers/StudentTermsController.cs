...
namespace DegreePlan.Controllers
{
    public class StudentTermsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StudentTermId,Term,TermAbv,TermName,StudentId,DegreeplanId")] StudentTerm studentTerm)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentTermId,Term,TermAbv,TermName,StudentId,DegreeplanId")] StudentTerm studentTerm)
        {
